...
import os
######testing sit change after uat passed
...
bronze_path = 's3://citi-bike-batch-data-si-test/bronze/'
silver_path = 's3://citi-bike-batch-data-si-test/silver/'
gold_path   = 's3://citi-bike-batch-data-si-test/gold/'
